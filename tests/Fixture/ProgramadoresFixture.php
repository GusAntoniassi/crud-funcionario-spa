...
class ProgramadoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'linguagem' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'github' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
    ...
    public $records = [
        [
            'id' => 1,
            'funcionario_id' => 1,
            'linguagem' => 'Lorem ipsum dolor sit amet',
