...
<head>
    ...
    <!-- Select2 -->
    <?php echo $this->Html->css('/js/select2/css/select2.min.css') ?>
    <?php echo $this->Html->script('select2/js/select2.full.js'); ?>
    <?php echo $this->Html->script('select2/js/i18n/pt-BR.js'); ?>
...
<body class="hold-transition skin-<?php echo Configure::read('Theme.skin'); ?> sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="loading-circle"><i class="fa fa-circle-o-notch fa-spin"></i></div>
            <?php echo $this->Flash->render(); ?>
            <?php echo $this->Flash->render('auth'); ?>
            <div class="inner-content-wrapper" id="content-wrapper">
