          ...
          <div class="box-tools">
            <form action="<?php echo $this->Url->build(); ?>" method="POST">
              <div class="input-group input-group-sm"  style="width: 180px;">
                <input type="text" name="search" class="form-control" placeholder="<?= __('Critérios do filtro') ?>">
...
%>
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', <%= $pk %>], ['confirm' => __('Tem certeza que quer excluir este registro?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
